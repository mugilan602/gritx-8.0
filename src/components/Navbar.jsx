...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <motion.button
                onClick={toggleMenu}
                className="fixed top-4 right-4 z-[100] text-white text-2xl p-3 bg-gray-800/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-gray-700 transition-colors duration-200"
