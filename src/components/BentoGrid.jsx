            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:auto-rows-[350px]">
                ...
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-white/10 hover:shadow-xl transition-all duration-300 group">
                    <div className="flex items-center gap-3 mb-6 cursor-pointer">
                        <h3 className="text-xl md:text-2xl font-semibold text-white group-hover:text-cyan-400 transition-colors duration-300">
                            Featured Project
                        </h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-start h-full">
                        ...
                        <div className="w-full sm:w-1/2 flex flex-col justify-center">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <span className="px-3 py-1 bg-cyan-500/20 text-cyan-300 text-xs rounded-full">React</span>
                                <span className="px-3 py-1 bg-purple-500/20 text-purple-300 text-xs rounded-full">Next.js</span>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 md:p-6 lg:p-8 shadow-lg border border-white/10 hover:shadow-xl transition-all duration-300 group overflow-hidden">
                    <div className="flex items-center gap-3 mb-4 md:mb-6 cursor-pointer">
                        <h3 className="text-lg md:text-xl font-semibold text-white group-hover:text-fuchsia-400 transition-colors duration-300">
                            Our Partners
                        </h3>
                ...
                <div className="lg:col-span-2 bg-white/5 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-white/10 hover:shadow-xl transition-all duration-300 group">
                    <div className="flex items-center gap-3 mb-6 cursor-pointer">
                        <h3 className="text-xl md:text-2xl font-semibold text-white group-hover:text-orange-400 transition-colors duration-300">
                            Community Impact
                        </h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-start h-full">
                        ...
                        <div className="w-full sm:w-1/2 flex flex-col justify-center">
                            ...
                            <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-4">
                                Join our vibrant community of innovators and creators working together to make a positive impact on the world.
                            </p>
                            <div className="flex flex-wrap gap-2">
                                <span className="px-3 py-1 bg-orange-500/20 text-orange-300 text-xs rounded-full">Community</span>
                                <span className="px-3 py-1 bg-red-500/20 text-red-300 text-xs rounded-full">Impact</span>
                                <span className="px-3 py-1 bg-yellow-500/20 text-yellow-300 text-xs rounded-full">Growth</span>
                            </div>
                        </div>
                    </div>
                </div>
